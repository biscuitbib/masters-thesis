...
def get_slice_loaders(path, volume_transform=None, n_train_slices=2000, n_val_slices=1000):
    ...
    train_loader = SliceLoader(train_data, slices_per_epoch=n_train_slices)
    ...
    val_loader = SliceLoader(val_data, slices_per_epoch=n_val_slices)
